...
- **Safe pair (good):** "Tamsin" and "Corv" — Levenshtein distance 6 (normalized 1.0), different first letters, different Double Metaphone codes, different syllable count (2 vs 1), different stress patterns, different vowel families (front vs back). No collision risk despite both being short.
