...
**Kill 2 — thin sensory world (v5.3.1, evidence: 2026-08-12 failure-mode trial).** A seed with no material world to picture is a concept, not a character. Ask: can I see the specific room they stand in? Can I picture their hands, the tools they use, the thing they're holding? If the answer is "a desk," "a ledger," "a room" — generic props that could belong to anyone — the seed is too thin. Kill it. The strongest seeds name a world you can walk through: a strand with tide-lines, a den with a specific kettle, a kitchen with a pot that has a history, a chapel with forty men in jumpsuits. A stockpot oracle (you can see the pot, the ladle, the bread on the sill) passes this test even though the pot never curdles — it has a world. A promise-collector (a desk and a ledger) does not.
