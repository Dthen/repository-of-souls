...
<div class="container">
  ...
  <article>
    ...
    <p>Hermes Agent stores personas in <code>config.yaml</code> under <code>agent.personalities</code>. Paste the contents of your <code>SOUL.md</code> there, then summon them with <code>/personality &lt;name&gt;</code> in any session.</p>

    <p><strong>Linux</strong></p>
    <pre><code>~/.hermes/config.yaml</code></pre>

    <p><strong>macOS</strong></p>
    <pre><code>~/.hermes/config.yaml</code></pre>

    <p><strong>Windows</strong></p>
    <pre><code>%USERPROFILE%\.hermes\config.yaml</code></pre>
